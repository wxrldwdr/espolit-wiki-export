(() => {
  ...
  const scrollGlowScript=document.createElement('script');scrollGlowScript.src='/surwave-site/assets/js/site-scroll-glow-runtime.js?v=20260814-2025';scrollGlowScript.defer=true;document.head.appendChild(scrollGlowScript);
