(() => {
  ...
  function apply(){applyLogo();bindCopyables(document);window.SurwaveSiteMediaRuntime?.apply?.();window.SurwaveInlineRichRuntime?.apply?.();window.SurwaveNavigationRuntime?.apply?.()}
