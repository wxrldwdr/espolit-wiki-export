(() => {
  ...
  const scrollGlowCss=document.createElement('link');scrollGlowCss.rel='stylesheet';scrollGlowCss.href='/surwave-site/assets/css/site-v10-scroll-glow.css?v=20260814-2135';document.head.appendChild(scrollGlowCss);
