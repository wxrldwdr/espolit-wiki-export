(() => {
  ...
  const shadeScript=document.createElement('script');shadeScript.src='/surwave-site/assets/js/ip-shade-runtime.js?v=20260812-2116';shadeScript.defer=true;document.head.appendChild(shadeScript);
