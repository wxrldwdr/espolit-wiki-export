(() => {
  ...
  const mediaScript=document.createElement('script');mediaScript.src='/surwave-site/assets/js/site-media-runtime.js?v=20260813-0945';mediaScript.defer=true;document.head.appendChild(mediaScript);
  ...
  function apply(){applyLogo();bindCopyables(document);window.SurwaveSiteMediaRuntime?.apply?.()}
