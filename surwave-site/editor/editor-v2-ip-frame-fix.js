(() => {
  ...
  .sw-copy-pair .sw-copy-card.sw-runtime-border-host>.sw-runtime-buffer-layer{display:block!important;inset:3px!important;border-radius:13px!important;background:var(--bg,#060a0c)!important;opacity:1!important;z-index:2!important}
  .sw-copy-pair .sw-copy-card.sw-runtime-border-host>.sw-runtime-inner-layer{inset:3px!important;border-radius:13px!important;background:#050809!important;opacity:var(--sw-bg-opacity,1)!important;transition:opacity .16s ease,inset .12s ease!important;z-index:3!important}
