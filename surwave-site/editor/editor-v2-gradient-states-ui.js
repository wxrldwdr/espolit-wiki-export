(() => {
  ...
  function stateEditor(block,layer,name){
    ...
    if(block.type==='servercards'&&layer==='border')note.textContent='Затемнение накладывается поверх градиента блока: «От центра» затемняет края, «Слева» — правую сторону, «Справа» — левую, «Сверху» — низ, «Снизу» — верх. Направление движения анимации следует тому же режиму.';
